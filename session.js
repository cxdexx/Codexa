...
async function fallbackSession() {
  try {
    ...
    // ✅ Add session info to URL without reloading the page
    const params = new URLSearchParams({ name, email, avatar: avatarFromURL });
...
await fallbackSession(); // only runs if query params are missing or incomplete
